...
\date{Slightly modified version of short course notes from Summer
  ...
  Annual Meeting, Boulder, Colorado, October, 2012} % delete this line to display the current date
...
\fltitem{To gain a clearer understanding of how a typical landscape evolution model (LEM) solves the type of governing equations that we have been learning about in class.}
...
%\bibliography{/Users/lancasts/Documents/Courses/GEO5XZ_Geomorph_Modeling/Exercises/Ex_05/Exercise_5_20120228}
