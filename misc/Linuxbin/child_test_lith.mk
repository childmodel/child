...
EXENAME = childLithTest$(EXEEXT)

OBJECTS = \
 childLithTestDriver.$(OBJEXT) \
...
childLithTestDriver.$(OBJEXT): $(PT)/tLithologyManager/childLithTestDriver.cpp
	$(CXX) $(CFLAGS) $(PT)/tLithologyManager/childLithTestDriver.cpp
