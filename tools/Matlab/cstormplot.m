...
%    Usage: [t,s] = cvolplot( fname, n )
%      fname = file name (including path)
%      n (opt) = number of lines in <fname>.storm file
%    Returns:
%      t = time vector (x-axis)
%      s = 3xN matrix containing interstorm duration (hrs), intensity
%      (mm/hr), and interstorm duration (hrs)
%   GT, May 2010
